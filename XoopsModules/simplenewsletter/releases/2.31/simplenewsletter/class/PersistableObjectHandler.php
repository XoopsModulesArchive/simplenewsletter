...
class Simplenewsletter_Object extends XoopsObject
{
 ...
 */
class Simplenewsletter_XoopsPersistableObjectHandler extends XoopsObjectHandler {
    ...
    */
    function __construct(&$db, $tablename, $classname, $keyname, $idenfierName = '', $cacheOptions=null) {
        ...
        if(is_null($cacheOptions)) {
        	$this->setCachingOptions(array('cacheDir' => SIMPLENEWSLETTER_CACHE_PATH, 'lifeTime' => null, 'automaticSerialization' => true, 'fileNameProtection' => false));
        } else {
    ...
    function &getObjects($criteria = null, $id_as_key = false, $as_object = true, $fields = '*', $autoSort = true)
    {
        ...
        $Cache_Lite = new Simplenewsletter_Cache_Lite($this->cacheOptions);
